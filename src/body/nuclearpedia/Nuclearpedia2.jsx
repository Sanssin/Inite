...
import poto from "../../assets/Reaktor.jpeg"
              ...
              >
                ...
                <div>
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.p1') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.p2') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step1_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step2_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step3_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step4_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step5_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article2.step6_desc') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
