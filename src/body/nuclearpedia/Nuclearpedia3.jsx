...
import poto from "../../assets/Eksterna.jpeg"
              ...
              >
                ...
                <div>
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article3.p1') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article3.types') }}
                  />                 
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article3.situations') }}
                  />                  
                  <p
                    style={{
                      color: "#e6e6e6",
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article3.p4') }}
                  />                  
                  <p
                    style={{
                      color: "#e6e6e6",
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article3.p5') }}
                  />                  
                  <p
                    style={{
                      color: "#e6e6e6",
