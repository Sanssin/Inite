...
import poto from "../../assets/Interna.png"
              ...
              >
                ...
                <div>
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.p1') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.ways') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.p2') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.factors') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.controls') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article4.resources') }}
                  />
                  <p
                    style={{
                      color: "#e6e6e6",
