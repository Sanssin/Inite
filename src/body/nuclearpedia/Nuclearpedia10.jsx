...
import poto from "../../assets/pertanian.jpeg"
import arrow from "../../assets/Arrow left-circle.png"

export const Nuclearpedia10 = () => {
              ...
              >
                ...
                <div>
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p1') }}
                  />
                  
                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h2')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p2') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h3')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p3') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h4')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p4') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h5')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p5') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h6')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p6') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article10.h7')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article10.p7') }}
                  />
