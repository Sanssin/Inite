...
import poto from "../../assets/industri.jpeg"
import arrow from "../../assets/Arrow left-circle.png"

export const Nuclearpedia9 = () => {
              ...
              >
                ...
                <div>
                  <p
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p1') }}
                  />
                  
                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article9.h2')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p2') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article9.h3')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p3') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article9.h4')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p4') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article9.h5')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p5') }}
                  />

                  <h4 style={{ fontWeight: "bold", color: "#e6e6e6", marginTop: 30 }}>{t('article9.h6')}</h4>
                  <p
                    style={{
                      color: "#e6e6e6",
                      marginTop: 10,
                    ...
                    dangerouslySetInnerHTML={{ __html: t('article9.p6') }}
                  />
